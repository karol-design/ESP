...
void square_path() {
    ...
    for(int i = 1; i < 9; i++) {
        motorLeft.setSpeed(1.0);     // Set the speed for motor1
        motorRight.setSpeed(1.0);     // Set the speed for motor2
    
        wait(5); // CHANGE TO SEE WHEN 0.5 m IS!!!
        ...
        if (i < 4){  
            // TURN LEFT
            motorRight.setSpeed(60);     // Set the speed for motor2
            wait(1); // WAIT UNTIL BUGGY TURNED 90 DEGREES
            motorRight.setSpeed(0);
        } else if (i == 4){
            motorLeft.setSpeed(60);
            wait(3); // WAIT UNTIL BUGGY TURNED 180 DEGREES
            motorLeft.setSpeed(0);     // Set the speed for motor1
        } else if (i == 8){
            ...
            motorLeft.setSpeed(60);
            wait(1); // WAIT UNTIL BUGGY TURNED 90 DEGREES
            motorLeft.setSpeed(0);     // Set the speed for motor2
        // CONTINUE
        }
    }
}
